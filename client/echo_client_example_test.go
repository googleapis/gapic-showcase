...
func ExampleEchoClient_EchoAuthentication() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	req := &genprotopb.EchoAuthenticationRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/github.com/googleapis/gapic-showcase/server/genproto#EchoAuthenticationRequest.
	}
	resp, err := c.EchoAuthentication(ctx, req)
	if err != nil {
		// TODO: Handle error.
	}
	// TODO: Use resp.
