...
func RegisterHandlers(router *gmux.Router, backend *services.Backend) {
	...
	router.HandleFunc("/v1/{name:operations}", rest.HandleListOperations).Methods("GET")
	router.HandleFunc("/v1/{name:operations/.+}", rest.HandleGetOperation).Methods("GET")
	router.HandleFunc("/v1/{name:operations/.+}", rest.HandleDeleteOperation).Methods("DELETE")
	router.HandleFunc("/v1/{name:operations/.+}:cancel", rest.HandleCancelOperation).Methods("POST")
