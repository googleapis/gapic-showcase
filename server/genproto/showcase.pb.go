...
func (c *showcaseClient) Retry(ctx context.Context, in *RetryId, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/google.showcase.v1alpha1.Showcase/Retry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Showcase_Retry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.showcase.v1alpha1.Showcase/Retry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() {
	proto.RegisterFile("google/showcase/v1alpha1/showcase.proto", fileDescriptor_showcase_ef3255cb2f457108)
}
