...
const file_google_showcase_v1beta1_rest_error_proto_rawDesc = "" +
	"\n" +
	"(google/showcase/v1beta1/rest_error.proto\x12\x17google.showcase.v1beta1\x1a\x19google/protobuf/any.proto\x1a\x15google/rpc/code.proto\"\xdf\x01\n" +
	"\tRestError\x12?\n" +
	"\x05error\x18\x01 \x01(\v2).google.showcase.v1beta1.RestError.StatusR\x05error\x1a\x90\x01\n" +
	"\x06Status\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12(\n" +
	"\x06status\x18\x04 \x01(\x0e2\x10.google.rpc.CodeR\x06status\x12.\n" +
	"\adetails\x18\x05 \x03(\v2\x14.google.protobuf.AnyR\adetailsBq\n" +
